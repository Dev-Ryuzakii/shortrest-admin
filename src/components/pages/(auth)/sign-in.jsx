    ...
    <div className='grid grid-cols-2 h-screen'>
      ...
      <div className='flex flex-col items-center justify-center py-8'>
        ...
        <p className="text-xl mb-4">
          ...
          <Link to="/sign-up" className="text-blue-500 cursor-pointer hover:underline">
            Create Account
          </Link>
        </p>
        <Form
          ...
          showPassword={true}  // Show password input if needed
        />
        <Button onClick={handleSubmit} className="mt-4">
          Submit
        </Button>
        <p className='text-xl mt-2'>
          <Link to="/forget-password" className='text-blue-500 cursor-pointer hover:underline'>
            Forgot password?
          </Link>
        </p>
